...
public final class GridListItemBinding implements ViewBinding {
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull ImageView carImage,
      @NonNull TextView carMake, @NonNull TextView carModel, @NonNull TextView carYear) {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GridListItemBinding((MaterialCardView) rootView, carImage, carMake, carModel,
          carYear);
    }
